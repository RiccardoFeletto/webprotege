...
//                    String parentId = parentTn.getId();
    ...
    protected ToolbarButton createCreateButton() {
        ...
        createButton.setDisabled(!hasWritePermission());             //vedi qui
        return createButton;
    }
    ...
    protected ToolbarButton createDeleteButton() {
        ...
        deleteButton.setDisabled(!getProject().hasWritePermission(Application.get().getUserId()));   //vedi qui
        deleteButton.setDisabled(!getDeleteEnabled());          //vedi qui
        return deleteButton;
    }
